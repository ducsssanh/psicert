    ...
    <div className="font-sans flex-col">
      ...
      <div className="relative flex-col mt-[13rem] px-4 lg:px-20 py-10">
        <div className="flex flex-col gap-6 translate-y-[-40px] mb-12">
          <p className="text-xl">
            DỊCH VỤ {">"} DỊCH VỤ TƯ VẤN CÔNG BỐ HỢP QUY{" "}
          </p>
          ...
          <div className="flex flex-col gap-4 w-full lg:w-2/3">
            ...
            <div className="bg-gray-100 p-6 shadow-md rounded">
              <p className="font-semibold">
                Bạn cần hỗ trợ các thủ tục trọn gói để có thể nhập khẩu sản phẩm
                điện - điện tử một cách dễ dàng và thuận lợi? Không chỉ thực
                hiện thử nghiệm, chúng tôi còn hỗ trợ khách hàng với dịch vụ tư
                vấn công bố hợp quy, giúp khách hàng tối ưu hoá công việc, nhanh
                gọn và dễ dàng hơn!
              </p>
            </div>
            {/* Additional Content */}
